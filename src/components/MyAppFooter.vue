  ...
  >
    ...
    <div class="col-6">
      ...
      <a href="#" class="text-decoration-none text-secondary"
        ...
        <span class="fs-5">Instagram</span> </a
      ><br />
      <a href="" class="text-decoration-none text-secondary"
        ><img style="width: 30px" src="@/assets/linkedin.png" alt="Linkedin" />
        <span class="fs-5"> Linkedin</span> </a
      ><br />
      <a href="" class="text-decoration-none text-secondary"
        ><img style="width: 30px" src="@/assets/X.png" alt="X" />
    ...
    <div class="col-6 mb-2">
      ...
      <a href="" class="text-decoration-none text-secondary"
        ...
        <span class="fs-5"> 01111110</span> </a
      ><br />
      <a href="" class="text-decoration-none text-secondary"
        ><img style="width: 29px" src="@/assets/mail-outline.svg" alt="email" />
        <span class="fs-5"> EgyMed@gmail.com</span> </a
      ><br />
      <a href="/contact" class="text-decoration-none text-secondary fs-5">
        Contact Form</a
      >
    </div>
    <br />
